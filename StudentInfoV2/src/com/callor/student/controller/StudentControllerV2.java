...
public class StudentControllerV2 {
	/*
	 * ControllerV1에서는 ServiceV1을 사용 할 때
	 * 기본 생성자를 호출하여 ServiceV1에서 stdList와 fileName을
	 * 직접 관리하도록 하였다
	 * 만약 list 변수와 파일을 다른 것으로 바꾸려면 어쩔 수 없이 ServiceV1 코드를
	 * 변경해야 한다
	 * 
	 * 하지만 V2에서는 ControllerV2에서 ServiceV2를 사용 할 때
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		/*
		 * stdList와 원본 데이터(student.txt) 파일을 생성자에 주입하여
		 * student.txt 파일에서 데이터를 읽어 stdList를 준비
		 */
